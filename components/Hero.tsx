      ...
      <div className="relative">
        ...
        <div className="flex justify-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20">
          <div className="max-w-[89vw] md:max-2xl: lg:max-w-[60vw] flex flex-col items-center">
            ...
            <TextGenerateEffect className='text-center text-6xl md:text-4xl lg:text-6xl' words='Transforming Concepts into Seamless Experiences' duration={0.5} />
            <TextGenerateEffect className='text-center tracking-wider text-sm md:text-xl lg:text-2xl' words='Hi, i&apos;m Muneeb, a passionate tech geek. Carrying digital persona all over the world.' duration={2.5} />
            ...
            <a href="/dummy-cv.pdf" download title='download cv' className='py-3'><SpecialButton /></a>
